 ...
 * @ORM\Entity(repositoryClass="DEV\PlatformBundle\Repository\ApplicationRepository")
 */
class Application
{
    /**
     * @ORM\ManyToOne(targetEntity="DEV\PlatformBundle\Entity\Advert", inversedBy="applications")
